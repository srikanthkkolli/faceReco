...
class Signin extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch('https://immense-fortress-75768.herokuapp.com/signin', {
      method: 'post',
          ...
          <div className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              ...
              <div className="mt3">
                ...
                <input
                  className="pa2 input-reset ba bg-#555555 hover-bg-black hover-white w-100"
                  type="email"
                  name="email-address"
                  id="email-address"
              ...
              <div className="mv3">
                ...
                <input
                  className="b pa2 input-reset ba bg-#555555 hover-bg-black hover-white w-100"
                  type="password"
                  name="password"
                  id="password"
